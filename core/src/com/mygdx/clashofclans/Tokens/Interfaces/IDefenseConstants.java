...
public interface IDefenseConstants {
    ...
    int CANYON_DEFENSE_LIFE = 10; //life
    ...
    String CANYON_DEFENSE_ANIMATION_NORTHWEST = "Objects/Cañón/Cañón (NO).gif";
    String CANYON_DEFENSE_ANIMATION_NORTHEAST = "Objects/Cañón/Cañón (NE).gif";
    String CANYON_DEFENSE_ANIMATION_SOUTHEAST = "Objects/Cañón/Cañón (SE).gif";
    String CANYON_DEFENSE_ANIMATION_SOUTHWEST = "Objects/Cañón/Cañón (SO).gif";
    ...
    String CANYON_DEFENSE_STATICANIMATION_NORTHWEST = "Objects/Cañón/Cañón  Estático (NO).gif";
    String CANYON_DEFENSE_STATICANIMATION_NORTHEAST = "Objects/Cañón/Cañón Estático (NE).gif";
    String CANYON_DEFENSE_STATICANIMATION_SOUTHEAST = "Objects/Cañón/Cañón Estático (SE).gif";
    String CANYON_DEFENSE_STATICANIMATION_SOUTHWEST = "Objects/Cañón/Cañón Estático (SO).gif";


    int MORTAR_DEFENSE_LIFE = 10; //life
    ...
    int TOWER_DEFENSE_LIFE = 10; //life
    ...
    String TOWER_DEFENSE_STATICANIMATION_LEFT = "Objects/Torre/Torre Estática L2.gif";
    String TOWER_DEFENSE_STATICANIMATION_RIGHT = "Objects/Torre/Torre Estática R2.gif";
    ...
    int AERIAL_DEFENSE_LIFE = 10; //life
    int AERIAL_DEFENSE_RANGE = 200; //range
    double AERIAL_DEFENSE_ATTACKRATE = 5; //attack rate
